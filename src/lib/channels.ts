...
export const CHANNELS: Channel[] = [
  ...
  { slug: 'antv', name: 'ANTV', category: 'nasional', tivieSlug: 'antv', provider: 'mncvision', providerRef: '115', logo: logo('YcwYQyql9CXniHlugQEaKNt7SmUNA9C8wajaWluo.png') },
  { slug: 'btv', name: 'BTV', category: 'nasional', tivieSlug: 'btv', provider: 'mncvision', providerRef: '103', logo: logo('ouHjfljSaPJbIXiCDuWpueKhzwXsjZffnHCu2MPU.png') },
  ...
  { slug: 'gtv', name: 'GTV', category: 'nasional', tivieSlug: 'gtv', provider: 'mncvision', providerRef: '81', logo: logo('2rxBtLwvNfFCPAIh9QO9xb4DhrfRVFvBqDa0WkKP.png') },
  { slug: 'indosiar', name: 'Indosiar', category: 'nasional', tivieSlug: 'indosiar', provider: 'mncvision', providerRef: '78', logo: logo('78gjGX7MXIIjHtkRfLMkL3SVWkOS1YCUJnfvM6mU.png') },
  { slug: 'inews', name: 'iNews', category: 'nasional', tivieSlug: 'inews', provider: 'mncvision', providerRef: '83', logo: logo('A1neyMyyenFNiu7xvKs7EGh1V79J7vLKCEi7NLCA.png') },
  { slug: 'kompas-tv', name: 'Kompas TV', category: 'nasional', tivieSlug: 'kompastv', provider: 'mncvision', providerRef: '106', logo: logo('rTo9S0kVnTIFEDNOnZpN8Iwk0FLtYeMEcQ4Nd9nq.png') },
  { slug: 'mdtv', name: 'MDTV', category: 'nasional', tivieSlug: 'mdtv', provider: 'mncvision', providerRef: '116', logo: logo('Lgu7coLBxNFLUXnABSGH8cEGomDz79ZQm4qMUcwr.png') },
  ...
  { slug: 'metro-tv', name: 'Metro TV', category: 'nasional', tivieSlug: 'metrotv', provider: 'mncvision', providerRef: '107', logo: logo('npwegJNO7Q2jrqfhxIpHamD66PJGzhVzYxsCJePj.png') },
  { slug: 'mnctv', name: 'MNCTV', category: 'nasional', tivieSlug: 'mnctv', provider: 'mncvision', providerRef: '82', logo: logo('796l5aHuo4L15YxBkBcqtpsCoSwNTXtSlZNxieXp.png') },
  ...
  { slug: 'rcti', name: 'RCTI', category: 'nasional', tivieSlug: 'rcti', provider: 'mncvision', providerRef: '80', logo: logo('xs1WvCTI8CBiAlPWhcMK9OI2PxxIbwV9eneps08K.png') },
  { slug: 'rtv', name: 'RTV', category: 'nasional', tivieSlug: 'rtv', logo: logo('28bjZF7ogxpmzglTONVLtE6L5cQp9it4Kr6xAR5w.png') },
  { slug: 'sctv', name: 'SCTV', category: 'nasional', tivieSlug: 'sctv', provider: 'mncvision', providerRef: '89', logo: logo('f1AU02SyUlsUy86Dy8KSjdX92E4YjXPQDjWHL7Ey.png') },
  { slug: 'sinpo-tv', name: 'Sin Po TV', category: 'nasional', tivieSlug: 'sinpotv', logo: logo('Moqav0dDQZ3HNslRsD3cCabStBpOsg4JbgfMkVaO.png') },
  { slug: 'trans-tv', name: 'Trans TV', category: 'nasional', tivieSlug: 'transtv', provider: 'mncvision', providerRef: '87', logo: logo('yjB7oMqNbF96glayEWNfFX6GenUDt2STtOkFeT5F.png') },
  { slug: 'trans7', name: 'Trans7', category: 'nasional', tivieSlug: 'trans7', provider: 'mncvision', providerRef: '110', logo: logo('amnYF03HkFucMQonA4Kgrz7nPL4Is0pz0f03dvrQ.png') },
  { slug: 'tvone', name: 'TvOne', category: 'nasional', tivieSlug: 'tvone', provider: 'mncvision', providerRef: '97', logo: logo('Uaep3l3FOpvB7WtMu1xQfBvqoqyB8S2ufhdfJURB.png') },
  { slug: 'tvri', name: 'TVRI', category: 'nasional', tivieSlug: 'tvri', provider: 'mncvision', providerRef: '118', logo: logo('XELJMrsGwfckbQ9AlilBa7BdWqmLrvF0DF3PoVKn.png') },
  { slug: 'vtv', name: 'VTV', category: 'nasional', tivieSlug: 'vtv', logo: logo('j3W5E19JVcaaKdNEVK3gss55n8pIpxE82ahs8zmn.png') },
  { slug: 'sindonews-tv', name: 'Sindonews TV', category: 'nasional', tivieSlug: 'sindonews', provider: 'mncvision', providerRef: '84' },
